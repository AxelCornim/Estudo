...
# ======================= CONFIGURAÇÕES =======================https://youtu.be/dulXo62zcjc?si=dTIhYlhWavHMZugc
...
def main():
    ...
    while True:
        ...
        print("3. Configurar pasta de destino")
        print("4. Sair")
        ...
        # Configurações
            ...
            new_path = input("\nNova pasta de destino: ").strip()
            if new_path:
                global SAVE_PATH
                SAVE_PATH = new_path
                print(f"✅ Pasta atualizada para: {SAVE_PATH}")
            else:
                print("❌ Nenhum caminho fornecido")
        
        # Sair
        elif choice in ['4', 'sair', 'exit']:
